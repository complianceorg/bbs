...
<div class="wrapper">
  ...
  <div class="login-box">
    ...
    <p class="log-text">下の2つの項目の中から一つ選んで、メールアドレス登録またはLINE友達登録またはtwitterの相互フォローを行ってください。折り返し、ログインに必要なパスワードをお教えします。</p>
    <p class="sentaku-text">■こちらの2つの選択肢の中から一つ選択してください</p>
